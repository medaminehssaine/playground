const LEVELS = [
    ...
    },
    {
        ...
        obstacles: [],
        instruction: "La ligne de drapeaux."
    },
    {
        id: 8, type: 0, gridSize: 6,
        turtle: { x: 0, y: 0, dir: 90 },
        goals: [{ x: 5, y: 0 }],
        obstacles: [
    ...
    {
        id: 14, type: 0, gridSize: 8,
        turtle: { x: 0, y: 0, dir: 90 },
        goals: [{ x: 7, y: 7 }],
        obstacles: [
            { x: 1, y: 1 }, { x: 3, y: 3 }, { x: 5, y: 5 }, { x: 2, y: 6 }, { x: 6, y: 2 }
        ],
        instruction: "Hard 3: Slalom géant."
    },
    {
        id: 15, type: 0, gridSize: 7,
        turtle: { x: 3, y: 6, dir: 0 },
        goals: [{ x: 3, y: 0 }],
        obstacles: [
            { x: 0, y: 3 }, { x: 1, y: 3 }, { x: 2, y: 3 }, { x: 4, y: 3 }, { x: 5, y: 3 }, { x: 6, y: 3 }
        ],
        instruction: "Hard 4: Le pont unique."
    },
    {
        ...
        instruction: "Hard 5: Le double mur."
    },
    {
        id: 17, type: 0, gridSize: 6,
        turtle: { x: 2, y: 3, dir: 90 },
        goals: [{ x: 5, y: 5 }],
        obstacles: [
            { x: 3, y: 3 }, { x: 3, y: 2 }, { x: 2, y: 2 }, { x: 2, y: 4 }, { x: 3, y: 4 }
        ],
        instruction: "Hard 6: Spirale de sortie."
    },
    {
        ...
        instruction: "Hard 7: Expert - Le drapeau est encerclé, trouve l'ouverture !"
    },
    {
        id: 19, type: 0, gridSize: 5,
        turtle: { x: 2, y: 2, dir: 90 },
        goals: [{ x: 4, y: 2 }],
        obstacles: [{ x: 3, y: 2 }, { x: 3, y: 1 }, { x: 3, y: 3 }, { x: 2, y: 1 }, { x: 1, y: 2 }], // Removed {x:2, y:3}
        instruction: "Hard 8: Évasion de la prison ! (Corrigé)"
    },
    {
        ...
        obstacles: [
            { x: 4, y: 0 }, { x: 4, y: 1 }, { x: 4, y: 2 }, // Removed {x:4, y:3}
            { x: 3, y: 4 }, { x: 2, y: 4 }, { x: 1, y: 4 }, { x: 0, y: 4 }
        ],
        instruction: "Hard 9: Le grand tour du quartier. (Corrigé)"
    },
    ...
    },
    {
        ...
        turtle: { x: 0, y: 1, dir: 90 }, // Moved start from (1,1) to (0,1)
        goals: [{ x: 3, y: 1 }, { x: 3, y: 3 }, { x: 1, y: 3 }, { x: 1, y: 1 }],
        obstacles: [],
        instruction: "Fais un carré avec 'repeter(4)' pour ramasser tous les drapeaux. (Corrigé)"
    },
    {
    ...
    // --- LEVEL 1 CHALLENGES (Code) - HARD ---
    {
        ...
        turtle: { x: 0, y: 1, dir: 0 }, // Moved start from (0,0) to (0,1) facing North
        goals: [{ x: 7, y: 0 }, { x: 7, y: 7 }, { x: 0, y: 7 }, { x: 0, y: 0 }],
        obstacles: [],
        instruction: "Hard Code 1: Le grand carré. Utilise une boucle de 4. (Corrigé)"
    },
    {
    ...
    {
        id: 34, type: 1, gridSize: 5,
        turtle: { x: 0, y: 0, dir: 90 },
        goals: [{ x: 4, y: 0 }, { x: 4, y: 4 }, { x: 0, y: 4 }],
        obstacles: [{ x: 2, y: 2 }],
        instruction: "Hard Code 4: Tour du monde sans toucher le centre."
    },
    {
        id: 35, type: 1, gridSize: 8,
        turtle: { x: 0, y: 0, dir: 90 },
        goals: [{ x: 7, y: 0 }],
        obstacles: [
        ...
        instruction: "Hard Code 5: Saute-mouton (contourne les obstacles)."
    },
    {
        id: 36, type: 1, gridSize: 9,
        ...
        instruction: "Hard Code 6: Double porte. Passe par les trous."
    },
    {
    ...
    {
        id: 38, type: 1, gridSize: 10,
        turtle: { x: 0, y: 0, dir: 90 },
        goals: [{ x: 9, y: 9 }],
        obstacles: [
            { x: 1, y: 1 }, { x: 2, y: 2 }, { x: 3, y: 3 }, { x: 4, y: 4 }, { x: 5, y: 5 }, { x: 6, y: 6 }, { x: 7, y: 7 }, { x: 8, y: 8 }
        ],
        instruction: "Hard Code 8: La diagonale interdite."
    },
    {
